...
void SpaceResection::calculate_space_resection(const char* camera_file_name, const char* point_file_name, const char* result_file_name)
{
	...
	cout << "φ = " << fixed << setprecision(5) << exterior_orientation_elements_.at<double>(3, 0) << endl;
	cout << "ω = " << fixed << setprecision(5) << exterior_orientation_elements_.at<double>(4, 0) << endl;
	cout << "κ = " << fixed << setprecision(5) << exterior_orientation_elements_.at<double>(5, 0) << endl;
	...
	outfile << "φ = " << fixed << setprecision(5) << exterior_orientation_elements_.at<double>(3, 0) << endl;
	outfile << "ω = " << fixed << setprecision(5) << exterior_orientation_elements_.at<double>(4, 0) << endl;
	outfile << "κ = " << fixed << setprecision(5) << exterior_orientation_elements_.at<double>(5, 0) << endl;
